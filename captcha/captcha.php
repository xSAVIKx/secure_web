...
$count = 3;    /* количество символов */
$width = 360; /* ширина картинки */
$height = 35; /* высота картинки */
$font_size_min = 20; /* минимальная высота символа */
$font_size_max = 30; /* максимальная высота символа */
...
$char_align = 28;    /* выравнивание символа по-вертикали */
$start = 100;    /* позиция первого символа по-горизонтали */
